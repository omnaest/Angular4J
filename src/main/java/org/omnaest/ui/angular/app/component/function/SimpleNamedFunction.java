...
public class SimpleNamedFunction implements NamedFunction
{
	private Function	function;
	private String		name;

	public SimpleNamedFunction(String name, Function function)
	{
		super();
		this.name = name;
	...
	{
		return this.function.getJavaScriptFunction();
	}
